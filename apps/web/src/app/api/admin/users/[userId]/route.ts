...
async function readUserMutationRequest(request: Request): Promise<Partial<AdminUserMutationRequest> | null> {
  try {
...
function normalizeUserMutation(body: Partial<AdminUserMutationRequest>): NormalizedUserMutation {
  return {
