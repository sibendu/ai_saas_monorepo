...
// Validate ../../../src/app/api/admin/roles/[roleId]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/roles/[roleId]">> = Specific
  const handler = {} as typeof import("../../../src/app/api/admin/roles/[roleId]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../src/app/api/auth/social-register-intent/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/social-register-intent">> = Specific
  const handler = {} as typeof import("../../../src/app/api/auth/social-register-intent/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
