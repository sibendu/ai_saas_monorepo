...
2. Do not launch VS Code, Cursor, or any other editor automatically.
3. Report the `{spec_file}` path so the user can open it themselves if they want to review the Suggested Review Order.
